            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    id="nombre"
                    type="text"
                    className="w-full px-0 py-2 border-0 border-b outline-none transition-all"
                    style={{
              ...
              <div>
                ...
                <textarea
                  id="mensaje"
                  rows={5}
                  className="w-full px-0 py-2 border-0 border-b outline-none transition-all resize-none"
                  style={{
                    borderColor: "rgba(196, 181, 160, 0.3)",
                    backgroundColor: "transparent",
                    color: "#c4b5a0",
