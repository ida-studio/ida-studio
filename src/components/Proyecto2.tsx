...
Esas decisiones siempre tienen consecuencias en el tiempo, la calidad, la relación con el cliente o en la rentabilidad de la construcción. <br /><br />
...
El tiempo es tu mejor aliado: Un sobrecosto del 5% detectado en el mes 2 puede corregirse, pero el mismo detectado en el mes 6 ya comprometió la inversión.<br /><br /> 

Pensamos no solo en que sea más fácil de ejecutar, sino también de mantener, siempre de la mano de la tecnología y la construcción responsable. 
Nuestro enfoque no es solo el presupuesto: es que entregues un proyecto que protege a tu cliente sin comprometer calidad ni diseño.<br /><br />
