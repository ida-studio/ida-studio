    ...
    >
      ...
      <div className="about-left">
        ...
        <p className="about-text">
          Centralizamos el modelado BIM para soluciones puntuales: construir un modelo digital inteligente que integra geometría, información técnica y criterios constructivos. permitiendo coordinar arquitectura, estructura, instalaciones y administración en un solo entorno. A lo largo del proyecto, el modelo facilita la detección de interferencias, la toma de decisiones informadas, la optimización de costos y la generación de documentación precisa para obra, asegurando coherencia entre diseño, ejecución y futuro mantenimiento.
        </p>
      </div>
